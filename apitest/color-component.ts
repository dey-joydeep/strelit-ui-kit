...
export class ColorComponent extends ComponentBase {
    ...
    private _beforeComponentReleaseEventListener = () =>
        this.handleBeforeComponentReleaseEvent();
    ...
    constructor(
        ...
        this.container.addEventListener(
            ...
            this._beforeComponentReleaseEventListener,
        );
    ...
    private handleBeforeComponentReleaseEvent(): void {
        ...
        this.rootHtmlElement.removeEventListener(
            'click',
            this._containerClickListener,
        );
        this.rootHtmlElement.removeEventListener(
