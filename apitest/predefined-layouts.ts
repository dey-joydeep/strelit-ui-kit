import { ItemType, LayoutConfig, StackItemConfig } from '../src';
...
export const prefinedLayouts: PredefinedLayouts = {
    colorComponentCompatible: [
        miniRowLayout,
        miniStackLayout,
        rowWithEmptyStackLayout,
        component,
        standardLayout,
        miniRowLayout_widthHeight,
        miniStackLayout_widthHeight,
        rowWithEmptyStackLayout_widthHeight,
        component_widthHeight,
        standardLayout_widthHeight,
    ],
    allComponents: [
        miniRowLayout,
        miniStackLayout,
        ...
        miniStackLayout_widthHeight,
        component_widthHeight,
        responsiveLayout_widthHeight,
        standardLayout_widthHeight,
        tabDropdownLayout_widthHeight,
    ],
};
