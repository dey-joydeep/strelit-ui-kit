...
export class VirtualLayout extends LayoutManager {
     ...
     * {@link VirtualLayout.unbindComponentEvent} with virtual components
     */
    releaseComponentEvent:
        VirtualLayoutReleaseComponentEventHandler | undefined;
    ...
    checkAddDefaultPopinButton(): boolean {
        if (this.layoutConfig.settings.popInOnClose) {
            ...
            popInButtonElement.setAttribute(
                'title',
                this.layoutConfig.header.dock,
            );
            ...
            popInButtonElement.addEventListener('click', () =>
                this.emit('popIn'),
            );
    ...
    override bindComponent(
        ...
        if (this.bindComponentEvent !== undefined) {
            const bindableComponent = this.bindComponentEvent(
                container,
                itemConfig,
            );
