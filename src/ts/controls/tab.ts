...
/** @internal */
export type TabCloseEvent = (componentItem: ComponentItem) => void;
/** @internal */
export type TabFocusEvent = (componentItem: ComponentItem) => void;
/** @internal */
export type TabDragStartEvent = (
  x: number,
  y: number,
...
export class Tab {
  ...
  constructor(
    ...
    /** @internal */
    private _closeEvent: TabCloseEvent | undefined,
    /** @internal */
    private _focusEvent: TabFocusEvent | undefined,
    /** @internal */
    private _dragStartEvent: TabDragStartEvent | undefined,
  ) {
  ...
  private onContentItemDestroy() {
    if (this._dragListener !== undefined) {
      const listener = this._dragListener;
  ...
  private onTabTouchStart(event: TouchEvent) {
    if (event.target === this._element || event.target === this._titleElement) {
      this.notifyFocus();
    }
  }
