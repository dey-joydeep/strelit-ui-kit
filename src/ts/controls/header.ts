...
export class Header extends EventEmitter {
    ...
    constructor(
        ...
        private _componentDragStartEvent:
            HeaderComponentDragStartEvent | undefined,
    ) {
        super();
    ...
    processActiveComponentChanged(newActiveComponentItem: ComponentItem): void {
        this._tabsContainer.processActiveComponentChanged(
            newActiveComponentItem,
        );
        this.updateTabSizes();
    }
    ...
    updateClosability(): void {
        ...
        this._canRemoveComponent =
            isClosable || this._tabsContainer.tabCount > 1;
    }
    ...
    processMaximised(): void {
        if (this._maximiseButton === undefined) {
            ...
            this._maximiseButton.element.setAttribute(
                'title',
                this._minimiseLabel,
            );
        }
